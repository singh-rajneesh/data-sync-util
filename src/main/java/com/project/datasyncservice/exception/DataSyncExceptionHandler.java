...
public class DataSyncExceptionHandler {
    ...
    public ResponseEntity<MobileApiResponseBO> handleUserServiceException(UserServiceException e) {
        log.error("AdvisorExceptionHandler.handleAdvisorServiceException():: exception = ", e);
    ...
    @ExceptionHandler(LMSNoContentException.class)
    public ResponseEntity<MobileApiResponseBO> handleLMSNoContentException(LMSNoContentException e) {
        log.error("AdvisorExceptionHandler.handleLMSNoContentException():: exception = ", e);
        return FarmRiseCommonUtils.getResponseEntity(null, e.getMessage(), HttpStatus.NO_CONTENT);
    }
}